//para crear mas rapido stf y enter para todo esto y crea un widget statefulk
...
class _MyWidgetState extends State<CounterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center, //columnas en el body
          children: [
            Text(
              '$contador',
